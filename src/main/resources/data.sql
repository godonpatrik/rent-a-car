...
insert into car (plate_num, year_of_make, km, color, is_avaliable ,start_of_parking, end_of_parking, created_at, updated_at) values ('CCC-123', 2015, 50000, 'grey', false, '2019-02-07', '2019-03-16', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
